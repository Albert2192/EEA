    ...
    <div class="sidebar">
        ...
        <div class="sidebar_profile">
            <div class="sidebar_profile_img">
                <img src="<?php echo $user_img;?>" alt="photo">
            </div>
            <div class="sidebar_profile_text">
                <p class="profile_text_first"><?php echo $user->user_name;?></p>
                <!-- <p class="profile_text_first">Alberto Aquino</p> -->
                <p class="profile_text_second"><?php echo $user->ciudad.", ".$user->pais;?></p>
    ...
    <div class="main">
        ...
        <div class="main_topbar">
            ...
            <div class="main_topbar_options">
                ...
                <div class="user_container"><img src="<?php echo $user_img;?>" alt="perfil"></div>

                <!-- MENU PERFIL -->
                <div id="menu_perfil" class="menu_perfil">
                    <div class="menu_perfil_header">
                        <div class="menu_perfil_img">
                            <img src="<?php echo $user_img;?>" alt="perfil_menu">
                        </div>
                        <div class="menu_perfil_text">
                            <p><?php echo $user->user_name;?></p>
                            <p><?php echo $user->rol; //echo $user->email;?></p>
                        </div>
                    </div>
...
<script src="<?php echo url();?>js/pages/dashboard.js?v=<?php echo $v; ?>"></script>